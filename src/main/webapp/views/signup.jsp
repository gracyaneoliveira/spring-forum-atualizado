...
<div class="row">
	...
	<div class="four columns">
		...
		<p>Esperamos poder lhe ajudar a dominar o máximo possível todos os conceitos por trás do Spring Framework e seus projetos relacionados</p>
	</div>
	...
	<sf:form modelAttribute="usuario" action="executarRegistro" enctype="multipart/form-data">
		...
		<input type="submit" value="Faça parte!" class="tiny button success"/>
	</sf:form>
	</div>
</div>