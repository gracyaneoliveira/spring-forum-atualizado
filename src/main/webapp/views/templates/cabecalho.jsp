...
<div class="row">
		...
		<div class="five columns right">
			...
			<sec:authorize access="isAnonymous()">
				<form style="margin-top: 1.0em;" action="<c:url value="/"/>" method="post">
					<div class="row">
			...
			<sec:authorize access="isAuthenticated()">
				Bem vindo(a) <sec:authentication property="principal"/> - <a href="<c:url value="/logout"/>">Sair</a>
				<%-- Bem vindo(a) <sec:authentication property="principal.username"/> - <a href="<c:url value="/logout"/>">Sair</a>  --%>
 			</sec:authorize>
